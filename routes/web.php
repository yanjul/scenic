...
Route::group(['prefix' => 'order', 'middleware' => 'auth'], function () {
    Route::match(['get', 'post'], '/create', 'OrderController@create')->middleware('pur:mobile');
    Route::match(['get', 'post'], '/create-distribution', 'OrderController@createDistribution')->middleware('pur:mobile');
